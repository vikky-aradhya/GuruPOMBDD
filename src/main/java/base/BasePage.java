...
public class BasePage {
    ...
    public static WebDriver openBrowser(String browserName) throws Throwable {
        ...
        if (browserName.equalsIgnoreCase("chrome")) {
            ...
            System.getProperty("webdriver.edge.driver",
                    System.getProperty("user.dir") + "/src/test/resources/drivers/MicrosoftWebDriver");
    ...
    public static void navigateToUrl() throws Exception {
        ...
        Reporter.addStepLog("Navigated to url Sucessfully");
    }
    ...
    public static void getScreenshot(String name) {
        ...
        try {
            ...
            ExtentReportGeneration.extentTest.log(Status.INFO, "Screenshot Captured" + "<a href='" + destinationPath.toString() + "'>Click Here</a>");
        } catch (IOException e) {
